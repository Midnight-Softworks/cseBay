...
<ul class="nav">
    ...
    <?php if (isset($_SESSION['username'])) echo "<li class=\"nav-item\"><a class=\"nav-link\" href=\"signOut.php\" style=\"color:black\">Sign out</a></li>";
        ...
        if (isset($_SESSION['username'])) echo "<li class=\"nav-item\"><a class=\"nav-link\" href=\"profile.php\" style=\"color:black\">" . ($_SESSION['username']) . "</a></li>";
        if (isset($_SESSION['type'])) {
            if ($_SESSION['type'] == "admin") {
                echo "<li class=\"nav-item\"><a class=\"nav-link\" href=\"administrative.php\" style=\"color:black\">Administrative</a></li>";
            }
        }
    ?>
